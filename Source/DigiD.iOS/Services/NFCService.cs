...
namespace DigiD.iOS.Services
{
    public class NfcService : INfcService
    {
        ...
        private static string GetPercentageRounds(double percentage)
        {
            if (percentage == 0)
                return "⚪⚪⚪⚪⚪⚪⚪⚪⚪⚪⚪";
            if (percentage > 0 && percentage <= 0.09090909090909090909090909090909)
                return "🔵⚪⚪⚪⚪⚪⚪⚪⚪⚪⚪";
            if (percentage > 0.09090909090909090909090909090909 && percentage <= 0.18181818181818181818181818181818)
                return "🔵🔵⚪⚪⚪⚪⚪⚪⚪⚪⚪";
            if (percentage > 0.18181818181818181818181818181818 && percentage <= 0.27272727272727272727272727272727)
                return "🔵🔵🔵⚪⚪⚪⚪⚪⚪⚪⚪";
            if (percentage > 0.27272727272727272727272727272727 && percentage <= 0.36363636363636363636363636363636)
                return "🔵🔵🔵🔵⚪⚪⚪⚪⚪⚪⚪";
            if (percentage > 0.36363636363636363636363636363636 && percentage <= 0.45454545454545454545454545454545)
                return "🔵🔵🔵🔵🔵⚪⚪⚪⚪⚪⚪";
            if (percentage > 0.45454545454545454545454545454545 && percentage <= 0.54545454545454545454545454545455)
                return "🔵🔵🔵🔵🔵🔵⚪⚪⚪⚪⚪";
            if (percentage > 0.54545454545454545454545454545455 && percentage <= 0.63636363636363636363636363636364)
                return "🔵🔵🔵🔵🔵🔵🔵⚪⚪⚪⚪";
            if (percentage > 0.63636363636363636363636363636364 && percentage <= 0.72727272727272727272727272727273)
                return "🔵🔵🔵🔵🔵🔵🔵🔵⚪⚪⚪";
            if (percentage > 0.72727272727272727272727272727273 && percentage <= 0.81818181818181818181818181818182)
                return "🔵🔵🔵🔵🔵🔵🔵🔵🔵⚪⚪";
            if (percentage > 0.72727272727272727272727272727273 && percentage <= 0.90909090909090909090909090909091)
                return "🔵🔵🔵🔵🔵🔵🔵🔵🔵🔵⚪";
